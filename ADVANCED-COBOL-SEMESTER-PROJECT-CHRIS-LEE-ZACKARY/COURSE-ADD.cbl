      ...
      ******************************************************************
       ...
       PROGRAM-ID. COURSE-ADD IS INITIAL PROGRAM.
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       ...
       01  SCR-TITLE.
           03  BLANK SCREEN.
           03  LINE 1 COL 1  VALUE "COURSE-ADD".
           03  LINE 1 COL 37 VALUE "UAFS".
           03  LINE 1 COL 71 FROM DISPLAY-DATE.       
 
       01  INSTRUCTORMENU.
           03  MENU.
               05  LINE 07 COL 32 VALUE "COURSE ADD".
               05  LINE 09 COL 36 VALUE "COURSE NUM".
               05  LINE 10 COL 36 VALUE "COURSE NAME".
               05  LINE 11 COL 36 VALUE "COURSE HRS".
