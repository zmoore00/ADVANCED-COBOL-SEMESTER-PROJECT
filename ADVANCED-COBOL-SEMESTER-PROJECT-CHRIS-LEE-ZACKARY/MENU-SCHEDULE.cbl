      ...
      ******************************************************************
       ...
       PROGRAM-ID MENU-SCHEDULE IS INITIAL PROGRAM.
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       ...
       01  SCR-TITLE.
           03  BLANK SCREEN.
           03  LINE 1 COL 1  VALUE "SCHEDULE-MENU".
           03  LINE 1 COL 37 VALUE "UAFS".
           03  LINE 1 COL 71 FROM DISPLAY-DATE.
           
       01  INSTRUCTORMENU.
           03  MENU.
               05  LINE 01 COL 01 VALUE "MENU-SCHEDULE".
               05  LINE 07 COL 32 VALUE " SCHEDULE MENU".
               05  LINE 09 COL 32 VALUE " 1) INQ BY CRN".
               05  LINE 10 COL 32 VALUE " 2) INQ BY CRSE".
               05  LINE 11 COL 32 VALUE " 3) ADD".
               05  LINE 12 COL 32 VALUE " 4) CHANGE".
       ...
       100-MAIN.
           ...
           PERFORM UNTIL WS-EXIT = 'Y' OR 'y'
               ...
               EVALUATE WS-SELECTION
                   WHEN '1' CALL 'SCHED-INQ-BY-CRN'
                   WHEN '2' CALL 'SCHED-INQ-BY-CRSE'
                   WHEN '3' CALL 'SCHED-ADD'
                   WHEN '4' CALL 'SCHED-CHANGE'
               END-EVALUATE
