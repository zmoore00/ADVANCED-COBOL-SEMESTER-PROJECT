      ...
      ******************************************************************
       ...
       PROGRAM-ID MENU-COURSE IS INITIAL PROGRAM.
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       ...
       01  SCR-TITLE.
           03  BLANK SCREEN.
           03  LINE 1 COL 1  VALUE "COURSE-MENU".
           03  LINE 1 COL 37 VALUE "UAFS".
           03  LINE 1 COL 71 FROM DISPLAY-DATE.
           
       01  INSTRUCTORMENU.
           03  MENU.
               05  LINE 01 COL 01 VALUE "MENU-COURSE".
               05  LINE 07 COL 32 VALUE " COURSE MENU".
       ...
       100-MAIN.
           ...
           PERFORM UNTIL WS-EXIT = 'Y' OR 'y'
               ...
               EVALUATE WS-SELECTION
                   WHEN '1' CALL 'COURSE-INQ'
                   WHEN '2' CALL 'COURSE-ADD'
                   WHEN '3' CALL 'COURSE-CHANGE'
