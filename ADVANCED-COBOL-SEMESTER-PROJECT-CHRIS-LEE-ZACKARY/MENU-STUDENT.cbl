      ...
      ******************************************************************
       ...
       PROGRAM-ID MENU-STUDENT IS INITIAL PROGRAM.
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       ...
       01  SCR-TITLE.
           03  BLANK SCREEN.
           03  LINE 1 COL 1  VALUE "STUDENT-MENU".
           03  LINE 1 COL 37 VALUE "UAFS".
           03  LINE 1 COL 71 FROM DISPLAY-DATE.
           
       01  INSTRUCTORMENU.
           03  MENU.
               05  LINE 01 COL 01 VALUE "MENU-STUDENT".
               05  LINE 07 COL 32 VALUE " STUDENT MENU".
               05  LINE 09 COL 32 VALUE " 1) INQ".
               05  LINE 10 COL 32 VALUE " 2) ADD".
               05  LINE 11 COL 32 VALUE " 3) CHANGE".
               05  LINE 12 COL 32 VALUE " 4) LIST".
       ...
       100-MAIN.
           ...
           PERFORM UNTIL WS-EXIT = 'Y' OR 'y'
               ...
               EVALUATE WS-SELECTION
                   WHEN '1' CALL 'STUDENT-INQ'
                   WHEN '2' CALL 'STUDENT-ADD'
                   WHEN '3' CALL 'STUDENT-CHANGE'
                   WHEN '4' CALL 'STUDENT-LIST'
               END-EVALUATE
